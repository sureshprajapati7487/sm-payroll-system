...
router.get('/', async (req, res) => {
    ...
    } catch (e) { addError(e, 'GET /api/overtime-policy'); res.status(500).json(formatError(e)); }
});
...
router.post('/', async (req, res) => {
    ...
    } catch (e) { addError(e, 'POST /api/overtime-policy'); res.status(500).json(formatError(e)); }
});
...
router.put('/:id', async (req, res) => {
    try {
        ...
        res.json(policy);
    } catch (e) { addError(e, 'PUT /api/overtime-policy/:id'); res.status(500).json(formatError(e)); }
});
...
router.delete('/:id', async (req, res) => {
    ...
    } catch (e) { addError(e, 'DELETE /api/overtime-policy/:id'); res.status(500).json(formatError(e)); }
});
